...
const consent = {
    ...
    stimulus: '<p style="color:#f5f5f7;"><b>Consent Form</b></p> <div style="text-align:left;' +
        'background-color:#2a2a2e; color:#f5f5f7; padding:24px 28px; max-width:900px;' +
        ...
        '<p style="color:#f5f5f7;"> Do you agree with the terms of the experiment as explained' +
        ' above? </p>',
    choices: ['I agree']
};